...
public class Replies {
    ...
    private static final SuccessOrFailureParser<Integer> INTEGER_REPLY_PARSER =
            new SuccessOrFailureParser<>(':', LongParser.INTEGER_PARSER);
    private static final SuccessOrFailureParser<Long> LONG_REPLY_PARSER =
            new SuccessOrFailureParser<>(':', LongParser.LONG_PARSER);
    private static final SuccessOrFailureParser<CharSequence> SIMPLE_STRING_REPLY_PARSER =
            new SuccessOrFailureParser<>('+', StringParser.INSTANCE);
    ...
    public static <E, T> ReplyParser<T> arrayReply(ArrayBuilderFactory<E, ? extends T> arrayBuilderFactory,
        ...
        return new SuccessOrFailureParser<>('*',
                new LenParser<>(len -> new ArrayParser<>(len, arrayBuilderFactory, elementParser)));
    }

    public static <K, V, T> ReplyParser<T> mapReply(MapBuilderFactory<K, V, ? extends T> arrayBuilderFactory,
